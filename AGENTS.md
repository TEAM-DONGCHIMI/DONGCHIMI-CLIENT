...
- 예정 package: `packages/tailwind-config`
- Node runtime, package manager, app layout, build system은 실제 `.node-version`, `package.json`, `pnpm-workspace.yaml`, `turbo.json`, `docs/architecture/*`를 source of truth로 봅니다.
...
- `README.md`, `docs/index.md`, `docs/code-quality/index.md`, `docs/agent/index.md`
...
| 코드 품질 리뷰                             | `.agents/skills/frontend-fundamentals-review/SKILL.md`, `.agents/skills/frontend-*-check/SKILL.md`, `.agents/skills/frontend-logic-composition-workflow/SKILL.md`, `docs/code-quality/index.md`, `docs/code-quality/frontend-fundamentals.md`, `recipes/frontend-fundamentals-review.md` |
...
| agent harness, README, 문서 구조 최신화    | `.agents/skills/verify-agent-docs/SKILL.md`, `.agents/skills/manage-skills/SKILL.md`, `docs/agent/index.md`, `docs/agent/indexing.md`, `docs/index.md`, `README.md`                                                                                                                      |
| skill 유지보수                             | `.agents/skills/manage-skills/SKILL.md`, `docs/agent/index.md`, `docs/agent/indexing.md`                                                                                                                                                                                                 |
| 브라우저 PR 리뷰                           | `.agents/skills/browser-pr-review-workflow/SKILL.md`, FE 코드 diff가 있으면 `.agents/skills/frontend-fundamentals-review/SKILL.md`, `docs/workflows/pull-request-writing.md`, `docs/workflows/pr-checklist.md`                                                                           |
...
페이지, 컴포넌트, hook, API, form 등 프론트엔드 구현 작업은 해당 workflow/recipe와 함께 `docs/code-quality/frontend-fundamentals.md`와 개별 기준 문서를 구현 품질 self-check 기준으로 사용합니다. 구현 중 특정 기준만 빠르게 확인해야 하면 `.agents/skills/frontend-readability-check/SKILL.md`, `.agents/skills/frontend-predictability-check/SKILL.md`, `.agents/skills/frontend-cohesion-check/SKILL.md`, `.agents/skills/frontend-coupling-check/SKILL.md`를 사용합니다. 컴포넌트 내부 로직이나 custom hook 추출 단위를 판단해야 하면 `.agents/skills/frontend-logic-composition-workflow/SKILL.md`를 사용합니다. 비자명한 변경, shared/public API 변경, PR 전 품질 점검은 `.agents/skills/frontend-fundamentals-review/SKILL.md`를 추가로 적용합니다.

## Source Of Truth

- 문서 인덱스: `docs/index.md`
- agent harness와 skill indexing: `docs/agent/index.md`, `docs/agent/indexing.md`
- 코드 품질 기준: `docs/code-quality/index.md`, `docs/code-quality/frontend-fundamentals.md`, `docs/code-quality/frontend-readability.md`, `docs/code-quality/frontend-predictability.md`, `docs/code-quality/frontend-cohesion.md`, `docs/code-quality/frontend-coupling.md`, `docs/code-quality/frontend-logic-composition.md`
...
- generator 명령과 workspace 검증은 실제 `package.json`, `turbo.json`, `turbo/generators/*`, `pnpm-workspace.yaml` 기준으로 확인한 뒤 실행합니다.
...
프론트엔드 앱 또는 package 변경은 `docs/workflows/local-development.md` 기준으로 format, lint, typecheck, build 검증을 추가합니다.
