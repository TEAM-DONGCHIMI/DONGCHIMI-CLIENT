...
페이지, 컴포넌트, hook, API, form 등 프론트엔드 구현 작업은 해당 workflow/recipe와 함께 `docs/code-quality/frontend-fundamentals.md`를 구현 품질 self-check 기준으로 사용합니다. 비자명한 변경, shared/public API 변경, PR 전 품질 점검은 `.agents/skills/frontend-fundamentals-review/SKILL.md`를 추가로 적용합니다.
