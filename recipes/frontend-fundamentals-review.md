...
- 개별 기준 문서: `docs/code-quality/frontend-readability.md`, `docs/code-quality/frontend-predictability.md`, `docs/code-quality/frontend-cohesion.md`, `docs/code-quality/frontend-coupling.md`
- Logic composition 문서: `docs/code-quality/frontend-logic-composition.md`
- Codex skill: `.agents/skills/frontend-fundamentals-review/SKILL.md`
- 개별 기준 skill: `frontend-readability-check`, `frontend-predictability-check`, `frontend-cohesion-check`, `frontend-coupling-check`
- Logic composition skill: `frontend-logic-composition-workflow`

Codex skill은 사이트를 자동으로 fetch하지 않습니다. 사이트의 실전 가이드 항목은 `docs/code-quality/frontend-fundamentals.md`와 개별 기준 문서에 반영된 내용만 리뷰 기준으로 사용됩니다.

## When To Use

- 구현 직후 코드 품질을 점검할 때
- 구현 중 특정 기준만 빠르게 확인해야 할 때
...
자세한 판단 기준은 `docs/code-quality/frontend-fundamentals.md`와 개별 기준 문서를 따릅니다.

- Readability: `docs/code-quality/frontend-readability.md`
- Predictability: `docs/code-quality/frontend-predictability.md`
- Cohesion: `docs/code-quality/frontend-cohesion.md`
- Coupling: `docs/code-quality/frontend-coupling.md`

구현 중 한 기준만 집중 점검하려면 아래 skill을 사용합니다. 기준 간 tradeoff가 보이면 통합 `frontend-fundamentals-review`로 돌아옵니다.
