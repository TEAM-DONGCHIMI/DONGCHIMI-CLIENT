...
- 오늘의 특가와 행사 할인 상품은 해당 API 연동 전까지 page-local fixture를 사용합니다.
...
- default: API 마트 정보와 TOP3, 오늘의 특가 2개, 행사 할인 상품 전체 카테고리를 표시합니다.
