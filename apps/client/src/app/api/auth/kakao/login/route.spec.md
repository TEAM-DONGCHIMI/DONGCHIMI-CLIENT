...
- upstream refresh cookie: 로그인 성공 계약의 필수 정보이며 브라우저에 HttpOnly cookie로 전달
...
- 성공 응답에 refresh cookie가 없으면 부분 로그인 상태를 만들지 않고 `502 OAUTH_REFRESH_TOKEN_MISSING`으로 응답합니다.
