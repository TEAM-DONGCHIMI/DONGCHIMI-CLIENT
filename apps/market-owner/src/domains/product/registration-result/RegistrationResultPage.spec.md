...
- mutation: `POST /v1/owners/markets/{marketId}/products/draft`
...
- draft 변경 또는 선택 삭제가 생기면 5초 간격으로 현재 row payload를 임시 저장합니다. 직전 성공 payload와 동일하면 중복 저장하지 않습니다.
...
- [x] edited rows auto-save on the configured interval
