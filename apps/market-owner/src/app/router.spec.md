...
- Jira: DCMSM-15
- Related Jira: DCMSM-17, DCMSM-20, DCMSM-24, DCMSM-26, DCMSM-33
...
- Sidebar footer의 `마트 정보 관리` 링크는 마트 정보 등록 route로 이동합니다.
...
- navigation: sidebar footer의 `마트 정보 관리`는 `/markets/information-registration`로 이동합니다.
...
- [ ] sidebar `마트 정보 관리` 링크가 마트 정보 등록 route로 이동
