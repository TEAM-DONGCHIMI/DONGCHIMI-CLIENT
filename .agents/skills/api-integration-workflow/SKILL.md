...
- 조건부 읽기:
  ...
  - `docs/code-quality/frontend-fundamentals.md`: hook return shape, API boundary, cache/error 책임의 응집도/결합도 self-check가 필요할 때
...
7. Frontend Fundamentals 기준으로 API helper, query/mutation hook, usage site의 책임 분리와 예측 가능성을 self-check합니다.
