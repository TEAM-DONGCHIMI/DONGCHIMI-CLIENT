...
- 조건부 읽기:
  ...
  - `docs/code-quality/frontend-fundamentals.md`: form state, validation, submit side effect의 응집도/결합도 self-check 허브가 필요할 때
  ...
  - `docs/code-quality/frontend-logic-composition.md`: form hook, field hook, submit orchestration 책임을 나눌 때
...
6. Frontend Fundamentals 허브, 개별 기준 문서, 필요 시 logic composition 기준으로 field/form 응집도, side effect 위치, hook return shape, 예측 가능성을 self-check합니다.
