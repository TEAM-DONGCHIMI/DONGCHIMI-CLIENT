...
3. 새 Next route page면 package script가 존재할 때 `gen:next-page` scaffold를 사용합니다.
...
8. `docs/code-quality/frontend-fundamentals.md` 기준으로 가독성, 예측 가능성, 응집도, 결합도 self-check를 수행합니다.
9. 검증 후 PR 준비 단계로 넘깁니다.
