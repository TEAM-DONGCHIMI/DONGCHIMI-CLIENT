...
```bash
rg -n "docs/code-quality\\.md|Test Checklist|What is this PR\\?|Spec / Docs" AGENTS.md README.md docs recipes templates .agents .github --glob '!**/verify-agent-docs/SKILL.md'
```
...
- code fence 안의 예시 경로는 markdown link 검사 대상에서 제외합니다.
